...
pnl = pl.read_parquet(results_folder / "daily_momentum_bt.parquet")
...
plt.xlabel(None)
plt.tight_layout()
plt.savefig(results_folder / "daily_momentum_sum_bt.png")
plt.clf()
...
plt.xlabel(None)
plt.tight_layout()
plt.savefig(results_folder / "daily_momentum_prod_bt.png")
plt.clf()
